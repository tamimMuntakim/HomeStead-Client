    ...
    return (
        <>
            ...
            <main className='w-11/12 md:container mx-auto md:h-[calc(100vh-96px)] md:grid md:grid-cols-12 md:gap-4 space-y-4 md:space-y-0'>
                <aside className=' md:col-span-3 flex justify-center bg-blue-400 text-white rounded-md overflow-hidden'>
                    <div className="md:h-full md:sticky top-[calc(96px)] md:flex md:items-center w-full">
                        <DashboardMenu></DashboardMenu>
                    </div>
                </aside>
                <div className='md:col-span-9 md:h-full md:overflow-y-auto bg-white rounded-md overflow-hidden'>
                    <Outlet></Outlet>
                </div>
            </main>
