...
const Register = () => {
    ...
    const { createUser, googleSignIn, updateInfo } = useContext(AuthContext);
    ...
    return (
        <div className="flex justify-center items-center py-8 bg-white rounded-md">
            ...
            <div className='flex flex-col md:flex-row-reverse gap-2 md:gap-4 md:items-center'>
                ...
                <div className="card bg-base-100 w-full max-w-sm shrink-0 shadow-2xl pt-5 border border-blue-200">
